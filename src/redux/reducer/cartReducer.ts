...
export const cartReducer = createSlice({
    ...
    reducers: {
        ...
        // reducer of calculate price of order
...
export const { addToCart, removeCartItem, calculatePrice, AppliedDiscount, saveShippingInfo, resetCart } = cartReducer.actions;