...
const PieCharts = () => {
  ...
  const { isLoading, data, isError } = usePieChartQuery(user?._id!);
  console.log(data);
  ...
  const revenue = data?.charts.revenueDistribution! || { burnt: 0, discount: 0, marketingCost: 0, netMargin: 0, productionCost: 0 };
